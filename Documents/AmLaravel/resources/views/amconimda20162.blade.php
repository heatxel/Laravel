...
<body>
  ...
  <div id="the-wrapper">
    <header id="mainHeader">
      ...
      <nav id="nav-main" class="menu">
        <ul>
          <li style="width:280px;"><a href="amconimda2016/home">Home</a></li>
      ...
      <nav id="nav-mobile">
        <ul>
          <li><a href="amconimda2016/home">Home</a></li>
  ...
  @yield('content')
    ...
    <footer id="mainFooter">
      <div class="row">
        <div class="col-md-12">
           <img class="logo-deltaAm" src="../assets/images/delta-am-01.png" alt="logo delta aeromexico">
