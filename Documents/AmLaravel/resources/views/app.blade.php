...
<head>
    ...
    <meta property="og:site_name" content="Quiero vivir una experiencia de vuelo a bordo del Simulador Dreamliner 787-9 ¡Regístrate!" />
    @if(Session::has('adress'))
    <meta property="og:url" content="{{Session::get('adress')}}" />
    @else
    <meta property="og:url" content="http://www.vuela.aeromexico.com/experienciadevuelo" />
    @endif
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Experiencia de vuelo" />
    <meta property="og:description" content="Quiero vivir una experiencia de vuelo a bordo del Simulador Dreamliner 787-9 ¡Regístrate." />
    @if (Session::has('picture'))
    <meta property="og:image" content="http://www.vuela.aeromexico.com/mayanchallenge/assets/images/share-facebook.jpg" />
    @else
    <meta property="og:image" content="http://www.vuela.aeromexico.com/mayanchallenge/assets/images/share-facebook.jpg" />
    @endif    
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:site" content="@aeromexico">
	<meta name="twitter:creator" content="@aeromexico">
	<meta name="twitter:title" content="¡Quiero vivir una experiencia de vuelo! ¿Qué esperas para vivir la tuya? Regístrate aquí:
| Aeromexico">
	<meta name="twitter:image" content="https://www.aeromexico.com/.galleries/tw/aeromexicoTweet.png">
	<meta name="twitter:description" content="Visita vuela.aeromexico.com/experenciadevuelo para más información">
	<meta name="twitter:image:alt" content="Aeromexico">
    <meta property="fb:app_id" content="1298044173548779" />         
...
<body>
  <!-- Google Tag Manager -->
  <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-PTTVTM"
  height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
  j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
  '//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
  })(window,document,'script','dataLayer','GTM-PTTVTM');</script>
  <div id="fb-root"></div>
...
<a id="btnSponsor" data-toggle="modal" data-target="#ourSponsors">our sponsors</a>

  <div id="the-wrapper">
    <header id="mainHeader">      <!-- menu desktop -->
       <a href="/simulador2" class="logo"><img src="assets/images/simulador_logo.png" alt="Simulador" /></a>  
    </header>
    <!-- dynamic -->
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="footer-info">           
            <p>&copy; 2016 Aeroméxico. Todos los derechos reservados. Consulta nuestro <a target="_blank" href="https://aeromexico.com/es/viaja-con-aeromexico/preparando-tu-viaje/reglamentos-y-politicas/aviso-de-privacidad/?site=mx">aviso de privacidad</a></p>
          </div>
        </div>
      </div>
    </footer>
...
<!-- modal success -->
<div class="modal fade" id="preregistroSuccess" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Simulador 2.0</h4>
      </div>
      <div class="modal-body text-centered">
        <h2>¡Felicidades! Serás de los primeros en recibir información.</h2>
      </div>
    </div>
  </div>
</div>
  <!-- / modal success-->
  <!-- modal T&C -->
  <div class="modal fade" id="terminos" tabindex="-1" role="dialog" aria-labelledby="terms">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
